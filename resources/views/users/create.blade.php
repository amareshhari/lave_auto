                ...
                <header id="topbar" class="alt">
                    <div class="topbar-left">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-current-item">Create User</li>
                        </ol>
                    </div>
                </header>
                    ...
                    <div class="allcp-form col-xs-12">
                        <div class="panel">
                            <div class="panel-heading pbn mb20">
                                <div class="panel-title pln ptn">Create New Admin User</div>
                            </div>
                            <div class="panel-body pn">
                                ...
                                <form method="post" action="javascript:void(0);" id="form-ui" enctype="multipart/form-data">
                                    ...
                                    <div class="row mn mln15">
                                        <div class="col-md-6">
                                            <div class="section">
                                                ...
                                                <input type="text" name="name" id="name" class="gui-input"
                                                       placeholder="Full Name" maxlength="200" minlength="2" required value="{{old('name')}}">
                                        ...
                                        <div class="col-md-6">
                                            <div class="section">
                                                ...
                                                <input type="email" name="email" id="email" class="gui-input"
                                                       placeholder="Email" maxlength="200" required value="{{old('email')}}">
                                                <span class="field-icon">
                                        ...
                                        <div class="col-md-6">
                                            <div class="section">
                                                ...
                                                <input type="text" name="mobile" id="mobile" class="gui-input"
                                                       placeholder="Mobile Number" maxlength="10" required value="{{old('mobile')}}">
                                                <span class="field-icon">
                                        ...
                                        <div class="col-md-6 d-none school-admin-section">
                                            <div class="section">
                                                <label class="field prepend-icon">
                                        ...
                                        <div class="col-md-6 d-none teacher-admin-section">
                                            <div class="section">
                                                <label class="field select">
                                            ...
                                            <div class="section">
                                                <label class="field prepend-icon">
                                                    <input type="file" class="dropify" name="image" data-allowed-file-extensions="jpeg jpg png"
                                                        accept="image/*" data-max-file-size="2M"/>
                                                </label>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- /section -->
                                    <button type="submit" class="btn btn-bordered btn-success btn-block">Create</button>
                                </form>
                                <!-- /form -->
                            </div>
                        </div>
